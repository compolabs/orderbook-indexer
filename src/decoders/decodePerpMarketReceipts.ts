...
import { PerpMarketAbi } from "@compolabs/spark-ts-sdk";
export function decodePerpMarketReceipts(
      ...
      order:
        log.order != null
          ? {
              ...
              base_size:
                (log.order.base_size.negative ? "-" : "") + log.order.base_size.value.toString(),
